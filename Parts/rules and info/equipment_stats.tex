...
\textit{Robots:} Senitent machines big enough to see are described using racial templates or as animals. See \textit{Machines as Characters} (p. \pageref{ch:machines_as_characters}). 
