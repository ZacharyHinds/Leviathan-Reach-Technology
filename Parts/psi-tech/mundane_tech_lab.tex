...
HyMRI scanners (p. \pageref{subsec:hymri_scanner}) can also function as EEGs (above) and can also map the exact areas of the brain that are active during psi use. They can also be useful for locating brain~-tissue grafts (p. TODO), other psi implants, or where to target an electro~-psionic neutralizer (p. \pageref{subsec:electro-psionic_neutralizer}).